...
# Must have project rile at root directory
...
```{r data cleanup}
custom.stopwords = c(stopwords('en'), 'alex', 'dallas', 'traci', 'danielle', 'gerald',
                     'margaret', 'traci', 'aris', 'carol', 'raphael', 'jannah',
                     'ryan', 'ana', 'dudleys', 'roseclair', 'savenors', 'endlittle', 
                     'juliet', 'laura', 'saras', 'boudoir', 'changs', 'kayla', 
                     'alexandra', 'owen', 'cherry', 'lily', 'harry', 'elena', 'pam')
