...
this platform, as could be the case if one wanted to go deeper into question 3 to assess
the workforce for weekends and opposed to weekdays, for instance.
Those questions can be answered before doing the preparation and cleaning steps, however,
for the sake of completeness though, those steps are shown below first.
