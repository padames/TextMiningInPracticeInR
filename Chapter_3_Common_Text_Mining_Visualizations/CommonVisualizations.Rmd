...
These word networks do provide some insight but are somewhat complicated to control to produce clear connections. Their use wit large bodies of text is cumbersome. They remain an exploratory tool to be used early on in text analysis but seldom used for final reporting.
