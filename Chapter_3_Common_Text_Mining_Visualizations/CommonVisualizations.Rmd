...
library(wordcloud)
terms <- attr(tdm.m, "dimnames")$Terms # the vector of terms stored in the list "dimnames" 
wordcloud(words = frequencies.df$word, freq = frequencies.df$frequency, max.words = 100, colors = c('black','darkred'))
```
